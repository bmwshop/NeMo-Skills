...
if category == "sec":
    input_file = f"/workspace/DATA/lc/lcrqagen_v3b1/sec/{template}-{args.data_chunk_size}-{args.data_maxlength}/intermediate_p.jsonl"
    output_dir = f"/workspace/DATA/lc/lcrqagen_v3b1/sec/{template}-{args.data_chunk_size}-{args.data_maxlength}/traces"
else:
    input_file = f"/workspace/DATA/lc/lcrqagen_v3b1/{template}-{args.data_chunk_size}-{args.data_maxlength}/intermediate_p.jsonl"
    output_dir = f"/workspace/DATA/lc/lcrqagen_v3b1/{template}-{args.data_chunk_size}-{args.data_maxlength}/traces"
