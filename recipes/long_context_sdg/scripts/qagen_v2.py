...
input_file = "/workspace/DATA/lc/lcrqagen_v2/Government_Consultations-16384-130000_40k.jsonl"
...
generate(
    ...
    postprocess_cmd=f"python /nemo_run/code/recipes/long_context_sdg/scripts/postprocess_qa.py {output_dir}/output.jsonl {output_dir}/Government_Consultations-16384-130000_qa.jsonl",
    # Server parameters
