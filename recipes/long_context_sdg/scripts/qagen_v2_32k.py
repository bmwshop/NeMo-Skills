...
input_file = "/workspace/DATA/lc/lcrqagen_v2/Government_Consultations-8192-31000_40k.jsonl"
output_file = "Government_Consultations-8192-31000_qa_32k.jsonl"
output_dir = "/workspace/DATA/lc/lcrqagen_v2_32k"
prompt_config = "/nemo_run/code/recipes/long_context_sdg/prompts/gen_qa_v2.yaml"
...
generate(
    ...
    postprocess_cmd=f"python /nemo_run/code/recipes/long_context_sdg/scripts/postprocess_qa.py {output_dir}/output.jsonl {output_dir}/{output_file}",
    # Server parameters
